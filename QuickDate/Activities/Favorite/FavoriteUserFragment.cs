...
namespace QuickDate.Activities.Favorite
{
    public class FavoriteUserFragment : Fragment
    {
        ...
        public FavoriteUserAdapter MAdapter;
        ...
        private async Task LoadDataAsync(string offset = "0")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                var (apiStatus, respond) = await RequestsAsync.Favorites.GetFavoritesAsync("25", offset);
                if (apiStatus != 200 || respond is not ListFavoritesObject result || result.Data == null)
                {
                    MainScrollEvent.IsLoading = false;
                ...
                else
                {
                    ...
                    if (respondList > 0)
                    {
                        ...
                        {
                            MAdapter.UserList = new ObservableCollection<FavoritesObject>(result.Data);
