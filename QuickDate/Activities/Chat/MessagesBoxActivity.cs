...
namespace QuickDate.Activities.Chat
{
    ...
    public class MessagesBoxActivity : AppCompatActivity, IOnClickListenerSelectedMessages
    {
        ...
        private CircleButton ChatSendButton, StickerButton, GiftButton, ImageButton;
        ...
        private void StartAudioCall()
        {
            try
            {
                ...
                if (dataSettings?.AgoraChatCall == "1")
                {
                    ...
                    intent.PutExtra("type", "Agora_audio_calling_start");
        ...
        private void StartVideoCall()
        {
            try
            {
                ...
                if (dataSettings?.AgoraChatCall == "1")
                {
                    ...
                    intent.PutExtra("type", "Agora_video_calling_start");
                    StartActivity(intent);
                }
                else if (dataSettings?.TwilioChatCall == "1")
                {
