...
namespace QuickDate.Activities.Live.Page
{
    ...
    public class LiveStreamingActivity : RtcBaseActivity, IEventHandler , MaterialDialog.IListCallback/*, PixelCopy.IOnPixelCopyFinishedListener*/
    {
        ...
        ////////////////////////////////
        private UserInfoObject LiveStreamViewerObject;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                {
                    case false:
                        LiveStreamViewerObject = JsonConvert.DeserializeObject<UserInfoObject>(Intent?.GetStringExtra("PostLiveStream") ?? "");
            ...
            try
            {
                ...
                switch (IsOwner)
                {
                    ...
                    default:
                    {
                        ...
                        {
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Avater, BgAvatar, ImageStyle.CenterCrop, ImagePlaceholders.Drawable);
        ...
        private void GoLiveButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Toast.MakeText(this, this.GetString(Resource.String.Lbl_PleaseEnterLiveStreamName), ToastLength.Short)?.Show();
                    return;
                }
        ...
        private void InitComponent()
        {
            try
            {
                FrameLayout RootView = FindViewById<FrameLayout>(Resource.Id.rootView);
        ...
        private void MMoreBtnOnClick(object sender, EventArgs e)
        {
            ...
            { 
                ...
                //dialogList.NegativeText(GetText(Resource.String.Lbl_Close)).OnNegative(new QuickDateTools.MyMaterialDialog());
            ...
            try
            {
                ...
                switch (IsOwner)
                {
                    ...
                    default:
                    {
                        if (LiveStreamViewerObject != null)
                        {
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Avater, MAvatarBg, ImageStyle.CenterCrop, ImagePlaceholders.Drawable);
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Avater, MAvatar, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);
                        }
        ...
        private void InitStreamerInfo()
        {
            ...
            { 
                ...
                if (LiveStreamViewerObject != null)
                {
                    GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Avater, streamerAvatar, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);
                    streamerName.Text = QuickDateTools.GetNameFinal(LiveStreamViewerObject);
        ...
        { 
            if (Methods.CheckConnectivity())
            {
                ...
                var (apiStatus, respond) = await RequestsAsync.Live.CheckCommentsLiveAsync(PostId, IsOwner ? "live" : "show"/*, "10", offset, resourceId, sid, fileList*/);
                ...
                if (itemString == GetText(Resource.String.Lbl_ViewProfile))
                {
                    switch (IsOwner)
                    {
                        case true:
                            ...
                            break;
                        default:
                            QuickDateTools.OpenProfile(this, "Close", LiveStreamViewerObject, null);
                            break;
                    }
                }
