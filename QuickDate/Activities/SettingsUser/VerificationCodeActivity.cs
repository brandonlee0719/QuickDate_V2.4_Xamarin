    ...
    public class VerificationCodeActivity : BaseActivity
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                Methods.SetColorEditText(TxtNumber3, AppSettings.SetTabDarkTheme ? Color.White : Color.Black);
                Methods.SetColorEditText(TxtNumber4, AppSettings.SetTabDarkTheme ? Color.White : Color.Black);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
