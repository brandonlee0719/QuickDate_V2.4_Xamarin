...
namespace QuickDate.Library.Anjo.CardStackView
{
    public class CardStackView : RecyclerView
    {
        ...
        public CardStackView(Context context) : base(context)
        {
            Initialize();
        }

        public CardStackView(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            Initialize();
        }

        public CardStackView(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            Initialize();
        }
